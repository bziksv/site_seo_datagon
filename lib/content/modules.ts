...
export const MODULE_PAGES: ModulePage[] = [
  ...
  },
  {
    ...
    lead:
      "Быстрая проверка позиций с учётом устройства, языка и гео. Поддержка проектов и больших списков ключей на платных тарифах.",
    features: ["Яндекс и Google", "Телефон, планшет, десктоп", "Анализ ТОП-100 и конкуренты"],
  },
  {
