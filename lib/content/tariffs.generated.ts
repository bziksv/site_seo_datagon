...
export const TARIFF_PLANS: TariffPlan[] = [
  {
    ...
    features: [
      ...
      "Анализ текста страницы: 3 проверки в месяц",
      "Анализ конкурентов по ключевым словам: 3 проверки в месяц",
      "Проверка индексации страниц (Яндекс и Google): 3 проверки в месяц",
...
export const TARIFF_COMPARE: Record<string, Record<string, string>> = {
  ...
  indexCheck: { Free: "3", Optimal: "600", Ultimate: "1 500", Maximum: "2 400" },
