...
export const MODULE_V2_OVERRIDES: Record<string, ModuleV2Override> = {
  ...
  "monitoring-saytov": {
    ...
    painGain: {
      ...
      gainTitle: "С мониторингом Датагон",
      gains: [
  ...
  "generator_slov": {
    ...
    painGain: {
      ...
      gainTitle: "С генератором Датагон",
      gains: [
