  ...
  items: [
    {
      ...
      text: "UTM, ROI, мета-теги, HTTP-заголовки, мониторинг — не переключаться между сервисами.",
    },
    {
    ...
    },
    {
      ...
      text: "Уведомления о проблемах — не пропустите поломку посадочной или ссылку.",
    },
    {
