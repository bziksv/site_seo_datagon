...
import {
  ...
  RELEVANCE_STATS,
  RELEVANCE_STEPS,
  RELEVANCE_TECH_LAYERS,
  RELEVANCE_TECH_SECTION,
  RELEVANCE_PLAIN,
  RELEVANCE_ZONES,
...
export function AnalizRelevantnostiLanding({ module }: Props) {
  return (
    <>
      ...
      <ModuleTechSection
        section={RELEVANCE_TECH_SECTION}
        layers={RELEVANCE_TECH_LAYERS}
      ...
      <div className="min-w-0 max-w-full overflow-x-clip bg-slate-50">
        <div className="mx-auto max-w-6xl px-4 py-14 md:py-20">
          ...
          <ModuleInsightsSection
            meta={RELEVANCE_INSIGHTS}
            grid={RELEVANCE_REPORT_GRID}
            highlight={RELEVANCE_REPORT_LSI}
            outcomes={RELEVANCE_REPORT_OUTCOMES}
            titleId="relevance-report-title"
          />
          ...
          <ModulePlainSection data={RELEVANCE_PLAIN} titleId="relevance-plain-title" />
