...
const MUST_HAVE = [
  ...
  "без лимитов",
  "Прогноз трафика",
  "Посчитайте ROI рекламной кампании",
  "Получить полный доступ",
];

const MUST_NOT = ["Что такое ROI", "Возможности сервиса", "Подробнее о работе сервиса", "Словарь терминов"];
